...
const nextConfig: NextConfig = {
  ...
  // Explicitly ensure production optimizations
  compiler: {
  ...
  images: {
    ...
    remotePatterns: [
      {
        protocol: 'https',
        hostname: 'mass-care.s3.eu-west-2.amazonaws.com',
      },
      {
        protocol: 'https',
        hostname: 'www.mass-care-agency.dev5.intersmarthosting.in',
      },
      {
        protocol: 'https',
